...
3. final_specialist
   Final-Specialist v2 / feature-branch repair:
...
TWO_D_FEATURE_NAMES = [
    ...
    # HOF/Gap/SA strict-scaffold repair descriptors.
    "NumCarbon",
    "NumHydrogen",
    "NumOxygen",
    "HeavyAtomCount",
...
def build_final_feature_matrices(
    ...
    print(
        "[INFO] Feature-branch repair enabled: "
...
def fit_targetwise_teacher_ensemble(
    ...
    for j, target in enumerate(TARGET_PROPS):
        ...
        if getattr(args, "force_hgs_robust_teachers", False) and target in HGS_REPAIR_TARGETS:
            forced_names = HGS_FORCED_TEACHER_MODELS.get(target, set())
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train 9-target HELS Hybrid Native-EGNN models with feature-branch ESP/QTAIM repair and vertical BDE labels.")
